...
namespace MartijnHoogendoorn.BizTalk.Wizards.CodeGenerators.CodeDom
{
    ...
    public static class PipelineComponentCodeGenerator
    {
        ...
        /// <param name="language">
        ///     the <see cref="C:implementationLanguages" /> value, defining which programming
        ///     language the code should be generated in
        /// </param>
            ...
            ImplementationLanguages language)
        {
            ...
            using (var sw = new StreamWriter(fileName))
            {
                ...
                var codeGenerator = RetrieveCodeGenerator(sw, language);
                ...
                codeMemberMethod.Statements.Add(new CodeAssignStatement(new CodeArgumentReferenceExpression("classid"),
                    new CodeObjectCreateExpression(typeof(Guid),
                        new CodeSnippetExpression("\"" + componentGuid + "\""))));
